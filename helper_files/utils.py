...
def max_distance(points):
    # row_v_matrix = points == points[0, :]
    # constant_col = row_v_matrix.all(axis=0)
    # full_dim_points = points[:, ~constant_col]
    # hull = ConvexHull(full_dim_points)
...
# plt.scatter(*zip(*np.array(points)[incremental_farthest_search(points, 5)]), color='r')
# plt.show()